(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prettier')) :
    typeof define === 'function' && define.amd ? define(['exports', 'prettier'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.YapiSDK = {}, global.prettier));
    ...
    ***************************************************************************** */
    ...
    var axiosType = 'import type { AxiosRequestConfig } from \'yapi-codegen\'';
    var jsdocAxiosType = "/**\n  * @typedef { import(\"yapi-codegen\").AxiosRequestConfig } AxiosRequestConfig\n  */";
    /** 兼容简写与全写 */
    var Versions = {
        typescript: "ts" /* TS */,
        ts: "ts" /* TS */,
    ...
    var format = function (lines) {
        ...
        return prettier__default["default"].format(codeString, prettierDefaultOption);
    };
    /** 获取Ts类型Str */
    ...
    exports.CommonFileItem = CommonFileItem;
    exports.JsApiItem = JsApiItem;
    exports.TsApiItem = TsApiItem;
    exports["default"] = CommonFileItem;
